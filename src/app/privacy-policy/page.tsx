...
const PrivacyPolicy = () => {
  return (
    <article className="w-[60%] py-20 mx-auto flex flex-col gap-5 ">
      <h2 className="font-semibold text-[40px] leading-none">Privacy Policy</h2>
      <p>
        Sandesh Apps built the AiFy app as a Freemium app. This SERVICE is
        provided by Sandesh Apps at no cost and is intended for use as is.
      </p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at AiFy unless otherwise
      ...
      <p>
        ...
        [AdMob](https://support.google.com/admob/answer/6128543?hl=en) [Google
      ...
      <p>
        ...
        hesitate to contact me at info@textaify.com.
      </p>
    </article>
  );
};
